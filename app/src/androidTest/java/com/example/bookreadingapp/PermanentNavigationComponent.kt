...
import com.example.bookreadingapp.PermanentNavigationDrawerComponent
...
class PermanentNavigationComponent {
    @get:Rule
    ...
    fun setup() {
        ...
        composeTestRule.activity.setContent {
            ...
            PermanentNavigationDrawerComponent(navController = navController as NavHostController, viewModel = BookReaderViewModel(
    ...
    @Test
    fun testNavigationRailFromHomeToLibraryScreen() {
    ...
    @Test
    fun testNavigationRailFromHomeToReadingScreen() {
        composeTestRule.apply {
    ...
    @Test
    fun testNavigationRailFromHomeToSearchScreen() {
        composeTestRule.apply {
    ...
    @Test
    fun testNavigationRailFromHomeToTableOfContents() {
        composeTestRule.apply {
    ...
    @Test
    fun testNavigationRailHomeScreenWorks(){
        composeTestRule.apply{
